...
6. With the new user created, let's run a quick query to verify the results. Select **New Query** again, and paste the following into the new query window. Replace `XXXXX` in the `USE` statement to include the proper name of your database which will be `ContosoAutoDb-XXXXX` (e.g., ContosoAutoDb-01234).
...
3. Copy the script below, and paste it into the query window. Replace `XXXXX` in the `USE` statement to include the proper name of your database which will be `ContosoAutoDb-XXXXX` (e.g., ContosoAutoDb-01234).
